locals {
  ...
  vnet_cidr_vwanh_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 0)
  vnet_cidr_wl1_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 1)
  vnet_cidr_wl2_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 2)
  primary_region_vnet_cidrs = {
    "wl1" = local.vnet_cidr_wl1_pri,
    "wl2" = local.vnet_cidr_wl2_pri
  }

  vnet_cidr_vwanh_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 0), null) : null
  vnet_cidr_wl1_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 1), null) : null
  vnet_cidr_wl2_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 2), null) : null
